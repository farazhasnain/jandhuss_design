        ...
        <div className="container my-5 py-5">
            <div className="row align-items-center g-5">
                <div className="col-lg-6 text-center text-lg-start">
                    <h1 className="display-3 text-white animated slideInLeft">Luxury<br />Right Away</h1>
                    ...
                    <a href="" className="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Book Now</a>
                </div>
                <div className="col-lg-6 text-center text-lg-end overflow-hidden">
                    <img className="img-fluid" src="img/fraz.png" alt="" />
                </div>
            </div>
        </div>
    </div>
